...
export function DocsSidebar() {
  ...
  return (
    <aside className='w-64 border-r border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-950 h-[calc(100vh-4rem)] overflow-y-auto lg:sticky lg:top-16'>
      <div className='px-4 py-6 space-y-4'>
        <div className='px-2'>
          ...
          <p className='text-sm text-zinc-500 dark:text-zinc-400'>
            Learn how to build with our tools
          </p>
        </div>
          ...
          {displayNavigation.map((section) => {
            ...
            return (
              <Collapsible
                ...
                className='group'
              >
                <CollapsibleTrigger className='flex items-center justify-between w-full px-3 py-2 text-sm font-medium rounded-md hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors cursor-pointer'>
                ...
                <CollapsibleContent className='mt-1 ml-4 pl-3 border-l border-zinc-200 dark:border-zinc-700 space-y-1'>
      ...
      >
        <div className='space-y-1'>
          <div className='flex items-center gap-1'>
            <CollapsibleTrigger className='flex items-center justify-between flex-1 text-sm px-3 py-2 rounded-md hover:bg-zinc-100 dark:hover:bg-zinc-900 transition-colors cursor-pointer'>
              <Link
                href={item.href}
                className={cn(
                  'flex-1 text-left',
              ...
              <ChevronDown className='h-3 w-3 text-zinc-500 transition-transform duration-200 group-data-[state=open]:rotate-180' />
            </CollapsibleTrigger>
          </div>
